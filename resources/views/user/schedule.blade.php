...
@section('content')
    <div class="w-full p-4 flex items-center justify-center">
        <div class="w-full max-w-4xl bg-blue-900 p-4 rounded-xl flex flex-col space-y-4">
            <h1 class="text-6xl text-white font-bold">Supletorio (1102)</h1>
            <h2 class="text-2xl text-white font-bold">Parcial 2</h2>
            <h3 class="text-xl text-white font-bold">Intento 4</h3>
