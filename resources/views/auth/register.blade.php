...
<div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-lg">
        <form method="POST" action="{{ route('register') }}"
            ...
            @csrf
            <p class="text-center text-lg font-medium">Regístrate</p>
            <div>
                <label for="name" class="sr-only">Correo institucional</label>
                ...
                <div class="relative">
                    <input type="text" class="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm"
                        ...
                        autocomplete="name" autofocus placeholder="Tu nombre" />
